...
import 'package:easy_invoice/dataRequestModel/Login&Register/RegisterRequestModel.dart';
      ...
      child: Scaffold(body: BlocBuilder<SignUpCubit, SignUpState>(
        builder: (context, state) {
          ...
          if (state is SignUpLoading) {
            return RegisterForm(isLoading: loading, message: '');
            ...
            return RegisterForm(
                isLoading: loading, message: "Password must be same.");
          }
          return RegisterForm(
            isLoading: loading,
            message: '',
