                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Stack(
                            children: [
                              if (imageFile !=
                                  null) // Check if a new local image is available
                                Image.file(
                                  imageFile!,
                                  width: 130,
                                  height: 130,
                                  ...
                                  image!
                                      .isNotEmpty) // Check if a network image is available
                                Image.network(
                                  image!,
                                  width: 130,
                                  height: 130,
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: RawMaterialButton(
                            ...
                            elevation: 3.0,
                            fillColor:  AdaptiveTheme.of(context).theme.iconTheme.color,
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        child:  Padding(
                          ...
                          child: Text(
                            'Edit User Role',
                            style: TextStyle(fontSize: 20,color: AdaptiveTheme.of(context).theme.iconTheme.color),
                          ),
                        ),
                      ),
                    ),
