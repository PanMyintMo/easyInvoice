...
class EditShopKeeperWidget extends StatefulWidget {
  ...
  const EditShopKeeperWidget({super.key, required this.isLoading, required this.quantity, required this.shCategoryId, required this.shProductId});
...
class _EditShopKeeperWidgetState extends State<EditShopKeeperWidget> {
  ...
  void validateAndSubmit() async {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<AddRequestProductShopKeeperCubit>().addRequestShopkeeperProduct(requestModel);
    } else {
      showDialog(
        context: context,
        builder: (context) {
