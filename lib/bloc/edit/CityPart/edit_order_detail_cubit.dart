...
import '../../../data/responsemodel/DeliveryPart/EditOrderDetailResponse.dart';
...
class EditOrderDetailCubit extends Cubit<EditOrderDetailState> {
  ...
  Future<void> updateOrderDetail(int id, EditOrderDetailRequestModel editOrderDetailRequestModel) async {
    ...
    try {
      final EditOrderData response = await _userRepository.editOrderDetail(id, editOrderDetailRequestModel);
